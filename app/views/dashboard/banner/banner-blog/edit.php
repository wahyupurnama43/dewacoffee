            ...
            <?php  $ID = Encripsi::encode('encrypt',$data['blog']['id']);?>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control"  name="judul"
                                    placeholder="Nama Banner Blog" value="<?= $data['blog']['judul'] ?>">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Deskripsi"
                                    name="deskripsi" value="<?= $data['blog']['judul'] ?>">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="dropzone dropzone-multiple" data-toggle="dropzone" data-dropzone-multiple
                                data-dropzone-url="<?=base_url('dashboard/edit_banner_blog/'.$ID)?>" data-form-submit="#frmTarget"
             ...
             <?php foreach ($data['gambar'] as $g): ?>
                        ...
                        <div class="d-flex justify-content-between px-5 py-2">
                            ...
                            <div class=""></div>
                            <div class="">
                                <a id="<?= $id ?>" data-url-page="<?= BASE_URL?>/dashboard/delete_img_blog/"  data-page-return="<?= BASE_URL?>/dashboard/edit_banner_blog/<?= $ID ?>" class="btn btn-danger hps-data text-white" style="margin-top: 30px;">Delete</a>
                            </div>
                        </div>
                    <?php endforeach ?>
        </div>
