                ...
                <div class="modal-body">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="judul" name="judul"
                                    placeholder="Judul Blog" value="<?= $data['blog']['judul'] ?> ">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <a id="<?= $tag['id'] ?>" class="btn btn-default btn-sm text-white hps-data" data-url-page="http://localhost/dewacoffee/dashboard/delete_tags" data-page-return="http://localhost/dewacoffee/dashboard/edit_blog/<?= $id  ?>">
