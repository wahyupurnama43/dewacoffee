...
<div class="row plr-4">
    ...
    <?php foreach ($data['barang'] as $barang): ?>
        <?php 
           ...
           $id = Encripsi::encode('encrypt', $barang['id_barang']);
       ?>
       <div class="col-lg-4">
        <div class="example-1 card">
            <div class="wrapper" style="background: url('http://inventaris.com/Inventaris_skensa/public/img/daftar-barang/<?= $barang['gambar'] ?>')">
                ...
                <div class="data">
                    <div class="content">
                          <span class="author d-flex justify-content-between">
                              <?= $barang['nama']; ?>
                              <span class=""></span>
                                  <div class="icon-actions">
                                    <a href="" class="like active likes" data-id="<?= $id ?>"><i class="ni ni-like-2"></i>
                                        <span class="text-muted likes" id="data-content"><?= $barang['like_count'] ?></span></a>
                                    <a href="#">
