            ...
            <?php foreach ($data['pinjam'] as $pinjam): ?>
              ...
              <tr>
                ...
                <td class="table-actions">
                  <?php $id_peminjam = Encripsi::encode('encrypt',$pinjam['id_peminjam']) ?>
                  <a  href="" class="table-action table-action-delete tombol-hapus" data-toggle="sweet-alert" data-sweet-alert="confirm" data-id="<?= $id_peminjam ?>" data-ct="hapus_proses_pinjam" data-href="<?= BASE_URL ?>/proses_pinjam/" data-toggle="tooltip" data-original-title="Hapus Barang">
