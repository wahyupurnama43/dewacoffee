<div class="about-img">
            <img src="<?= BASEURL?>/assets/img/about-us.jpg" alt="" data-aos="fade-down" data-aos-delay="300">
        </div>
        <div class="container">
            <div class="card about-card p-5">
                <h1 class="judul" data-aos="fade-down" data-aos-delay="400">
                    About Dewa Coffee
                </h1>
                <p class="deskripsi" data-aos="fade-down" data-aos-delay="500">
