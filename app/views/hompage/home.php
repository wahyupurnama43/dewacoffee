                ...
                <div class="col-lg-6 col-md-6 col-sm-12 text">
                    <div class="text-banner">
                        ...
                        <p data-aos="fade-right" data-aos-delay="600">
                            Dewa coffee "coffee specialist" is an online coffee shop that sells various types of coffee
                            in Indonesia. The coffee that we sell comes from farmers and coffee who have full dedication
                            to produce coffee that has
                            the best taste.
                        </p>
                        <a href="products.html" class="btn btn-coffee" data-aos="fade-right" data-aos-delay="700">Show
                            Product</a>
                    </div>
                </div>
                    ...
                    <div class="wrap">
                        ...
                        <div id="testim-content" class="cont">
                            <div class="active">
                                ...
                                <p>Fansnya kopi kali, Paling suka sama Kopi Bali Blend setiap bulan pasti selalu sediain
                                    stok bali blend untuk saya dan ayah saya :). Kopitem mantul deh harga terjangkau
                                    lagi.</p>
                            </div>
