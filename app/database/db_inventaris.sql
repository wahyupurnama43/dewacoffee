...
(4, '2020-04-25', 0, '2020-04-27', 17, 92),
(5, '2020-04-30', 20000, '2020-05-02', 5, 96);
...
INSERT INTO `tb_like` (`id_like`, `id_barang`, `id_auth`) VALUES
(70, 46, 5),
(25, 0, 16),
(52, 43, 16),
(53, 46, 16),
...
INSERT INTO `tb_pinjam` (`id_peminjam`, `tanggal_pinjam`, `tanggal_kembali`, `status`, `lama_pinjam`, `id_auth`) VALUES
(120, '2020-05-22', '2020-05-24', 1, 2, 5),
(121, '2020-05-22', '0000-00-00', 0, 3, 5);
...
ALTER TABLE `tb_like`
  ...
  ADD UNIQUE KEY `uk_tb_like` (`id_auth`,`id_barang`) USING BTREE;
...
ALTER TABLE `tb_pinjam`
  ...
  ADD UNIQUE KEY `uk_tb_pinjam` (`id_auth`,`status`);
...
--
ALTER TABLE `detail_pinjam`
  MODIFY `id_detail_pinjam` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=99;
...
--
ALTER TABLE `tb_like`
  MODIFY `id_like` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=71;

--
-- AUTO_INCREMENT untuk tabel `tb_pinjam`
--
ALTER TABLE `tb_pinjam`
  MODIFY `id_peminjam` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=125;
